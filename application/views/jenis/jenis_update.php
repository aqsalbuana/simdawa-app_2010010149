                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                <label for="nama" class="col-md-2">Nama Jenis Beasiswa</label>
                                <div class="col-md-10">
                                    <input type="text" name="nama_jenis" id="nama" class="form-control" required placeholder="Nama Jenis Beasiswa" value="<?= $jenis->nama_jenis ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ket" class="col-md-2">Keterangan</label>
                                <div class="col-md-10">
                                    <input type="text" name="keterangan" id="ket" class="form-control" required placeholder="Keterangan" value="<?= $jenis->keterangan ?>">
                                </div>
                            </div>
